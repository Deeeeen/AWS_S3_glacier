...
def initiate_inventory_retrieval(account_id, glacier_vault, out_file):
	...
	print("Initiate inventory retrieval for Glacier vault " + glacier_vault)
	print(response)
...
def help():
	...
	print("Initiate an inventory-retrieval job for an AWS Glacier vault")
...
if __name__=="__main__":
	...
	initiate_inventory_retrieval(account_id, glacier_vault, out_file)
